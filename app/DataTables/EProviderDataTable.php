...
class EProviderDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ->editColumn('image', function ($eProvider) {
             ...
             ->editColumn('email', function ($eProvider) {
                //  dd($eProvider->users()->first()->email);
                 $email =  isset($eProvider->users) ?  (($eProvider->users()->first()) ? $eProvider->users()->first()->email : null) : null;
                return $email;
            })
    ...
    protected function getColumns()
    {
        $columns = [
            [
                'data' => 'id',
                // 'title' => trans('lang.e_provider_id'),
                'title' => 'ID',
            ...
            [
             ...
             [
                'data' => 'email',
                'title' => trans('lang.e_provider_email'),
