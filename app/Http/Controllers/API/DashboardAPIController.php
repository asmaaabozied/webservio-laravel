...
class DashboardAPIController extends Controller
{
    ...
    public function provider(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $eprovidersCount['value'] = ($this->eproviderRepository->all('e_providers.id')->count() > 0) ? ($this->eproviderRepository->all('e_providers.id')->count()) -1 : $this->eproviderRepository->all('e_providers.id')->count();
