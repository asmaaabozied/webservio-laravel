...
class UpdateCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        User::$rules['email'] = 'required|max:255|email|unique:users,email,' . $this->route('customer');
        User::$rules['phone_number'] = 'required|max:255|unique:users,phone_number,' . $this->route('customer');
