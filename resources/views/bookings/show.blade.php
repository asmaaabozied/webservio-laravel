                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex flex-column mx-3">
                                ...
                                <span><b><a href="{{route('eServices.edit' ,$booking->e_service->id)}}">{{$booking->e_service->name}}</a></b>
                                <small class="mx-3"><a href="{{route('eProviders.edit' ,$booking->e_provider->id)}}"> {{__('lang.by')}} {{$booking->e_provider->name}}</a></small></span>
                                <small  class="mx-3">Employees
                                @foreach($booking->e_provider->users as $employee)
                                <a href="{{route('e_ProviderAdmins.edit' ,$employee->id)}}">{{$employee->name}}</a></span>
                               @endforeach
                               </small>
                            </div>
