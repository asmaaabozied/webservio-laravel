{!! Form::open(['route' => ['e_ProviderAdmins.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group btn-group-sm'>
    <a data-toggle="tooltip" data-placement="left" title="{{trans('lang.eProviderAdmin_edit')}}" href="{{ route('e_ProviderAdmins.edit', $id ).'?view=edit' }}" class='btn btn-link'>
