...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    @if(request('view') && request('view')=='edit')
            ...
            @if(auth()->user()->hasRole('super admin') || auth()->user()->hasRole('admin'))
                <div class="d-flex flex-row justify-content-between align-items-center">
                        {!! Form::label('verified', trans('lang.eProviderAdmin_verified'), ['class' => 'control-label my-0 mx-3']) !!} {!! Form::hidden('verified', 0, ['id' => 'hidden_verified']) !!}
    ...
    <button type="submit" class="btn bg-{{setting('theme_color')}} mx-md-3 my-lg-0 my-xl-0 my-md-0 my-2">
        <i class="fas fa-save"></i> {{trans('lang.save')}} {{trans('lang.eProviderAdmin')}}</button>
    <a href="{!! route('e_ProviderAdmins.index') !!}" class="btn btn-default"><i class="fas fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
