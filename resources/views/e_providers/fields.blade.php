...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    @prepend('scripts')
        <script type="text/javascript">
                ...
                init: function() {
                    @if (isset($eProvider) && $eProvider->hasMedia('image'))
                        ...
                        var16105363151854745906ble.forEach(media => {
                            // dzInit(this, media, 'https://new.weservio.com/admin/public' + media.thumb);
                            dzInit(this, media, media.url);
            ...
            // dz.var16105363151854745906ble[0].previewsContainer.lastChild.classList.add('dz-success');
...
<div class="d-flex flex-column col-sm-12 col-md-6">
    ...
    <!-- Addresses Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('addresses[]', trans('lang.e_provider_addresses'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
    ...
    <!-- Taxes Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('taxes[]', trans('lang.e_provider_taxes'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <div class="input-group-text text-bold px-3">
                        {{ trans('lang.app_setting_' . setting('distance_unit', 'mi')) }}</div>
                </div>
            </div>
            <div class="form-text text-muted">
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        {!! Form::label('languages[]', trans('lang.e_provider_languages'), [
            'class' => 'col-md-3 control-label text-md-right mx-1',
        ]) !!}
        <div class="col-md-9">
            {!! Form::select('spoken_languages', ['English', 'Arabic', 'Deutsch', 'Espagnal', 'French', 'Portuguese'], $languageSelected, [
                'class' => 'select2 form-control',
                'multiple' => 'multiple',
            ]) !!}
            <div class="form-text text-muted">{{ trans('lang.e_provider_languages_placeholder') }}</div>
        </div>
    </div>
    <!-- Image Field -->
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
...
<div
    ...
    <div class="d-flex flex-row justify-content-between align-items-center">
        ...
        <span class="icheck-{{ setting('theme_color') }}">({{ trans('lang.only_ifhas_available_hours') }})
