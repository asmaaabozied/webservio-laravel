    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-edit mr-2"></i>{{trans('lang.experience')}}</a>
                </li>
        ...
        <div class="card-body">
            <div class="row">
                <div class="d-block">
                    <button class="btn btn-primary ml-5" id="create_experience_btn">Add Experience</button>
                </div>
                <div class="create_modal d-none">
                    {!! Form::open(['route' => 'experiences.store']) !!}
                    <div class="row">
                        @include('experiences.provider_fields')
                    </div>
                    {!! Form::close() !!}
                    <div class="clearfix"></div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class='btn-group btn-group-sm'>
                                    ...
                                    <a data-toggle="tooltip" data-placement="left" title="{{trans('lang.experience_edit')}}" href="{{ route('experiences.edit', $experience->id) }}" class='btn btn-link'>
                                ...
                                <!-- <a  href="{!! route('experiences.edit',$experience->id) !!}"><i class="fa fa-edit mr-2"></i></a>
                                                {!! Form::open(['route' => ['experiences.destroy', $experience->id], 'method' => 'delete']) !!}
                                                {!! Form::button('<i class="fas fa-trash"></i>', [
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#create_experience_btn').on('click', function() {
            $('.create_modal').removeClass('d-none');
            $('.create_modal').addClass('d-block');
            $('#create_experience_btn').prop('disabled', true);

        });
        $('#cancel').on('click', function() {
            $('.create_modal').removeClass('d-none');
            $('.create_modal').addClass('d-block');
            $('#create_experience_btn').prop('disabled', false);
