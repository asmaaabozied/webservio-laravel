...
@can('customers.index')
<li class="nav-item">
    <a class="nav-link {{ Request::is('customers*') ? 'active' : '' }}" href="{!! route('customers.index') !!}">@if($icons)
...
@can('employees.index')
<li class="nav-item">
    <a class="nav-link {{ Request::is('employees*') ? 'active' : '' }}" href="{!! route('employees.index') !!}">@if($icons)
        <i class="nav-icon fas fa-users"></i>@endif
        <p>{{trans('lang.employee_plural')}}</p>
    </a>
</li>
@endcan

@can('e_ProviderAdmins.index')
<li class="nav-item">
    <a class="nav-link {{ Request::is('e_ProviderAdmins*') ? 'active' : '' }}" href="{!! route('e_ProviderAdmins.index') !!}">@if($icons)
        <i class="nav-icon fas fa-users"></i>@endif
        <p>{{trans('lang.eProviderAdmin_plural')}}</p>
    </a>
</li>
@endcan
...
<li class="nav-item has-treeview {{ (Request::is('eProvider*') || Request::is('requestedEProviders*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*') ) && !Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
    ...
    <ul class="nav nav-treeview">
        ...
        @can('videos.index')
        <li class="nav-item">
            <a class="nav-link {{ Request::is('videos') ? 'active' : '' }}" href="{!! route('videos.index') !!}">@if($icons)
                <i class="nav-icon fas fa-image"></i>@endif<p>{{trans('lang.video_plural')}}</p></a>
        </li>
        @endcan
        @can('awards.index')
        <li class="nav-item">
