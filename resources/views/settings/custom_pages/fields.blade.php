...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    <div class="d-flex flex-row justify-content-between align-items-center">
        {!! Form::label('web', trans("lang.custom_page_web"),['class' => 'control-label my-0 mx-3']) !!} {!! Form::hidden('web', 0, ['id'=>"hidden_web"]) !!}
        <span class="icheck-{{setting('theme_color')}}">
            {!! Form::checkbox('web', 1, null) !!} <label for="web"></label> </span>
    </div>
    <div class="d-flex flex-row justify-content-between align-items-center">
        {!! Form::label('mobile', trans("lang.custom_page_mobile"),['class' => 'control-label my-0 mx-3']) !!} {!! Form::hidden('mobile', 0, ['id'=>"hidden_mobile"]) !!}
        <span class="icheck-{{setting('theme_color')}}">
            {!! Form::checkbox('mobile', 1, null) !!} <label for="mobile"></label> </span>
    </div>
    <div class="d-flex flex-row justify-content-between align-items-center">
